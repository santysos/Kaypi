...
class RetencionController extends Controller
{
    ...
    {
        $re = 1;
        return view("compras.retenciones.show", ["re" => $re]);
    }
    ...
    public function store(RetencionFormRequest $request)
    {
        ...
        $retencion->numero = $request->get('numero');
        ...
        $retencion->tipo_documento ="04";
             ...
             while ($cont < count($idimpuesto)) {
                 ...
                 $detalle->numero_comprobante           = $retencion->numero;
                 $detalle->porcentaje                   = $idporcentaje_valor[$cont];
                 $detalle->tipo                         = $idporcentaje[$cont];
        ...
        Session::flash('message', "Retención #" . $retencion->idtb_ordenes . " creada Satisfactoriamente");
