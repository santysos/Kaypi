...
<h1>Editar Proveedor: <span class="label label-primary">
...
@section('content')
{!!Form::model($persona,['method'=>'PATCH','route'=>['proveedor.update',$persona->idtb_proveedor]])!!}
{!!Form::token()!!}
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('razon_social',null,['class'=>'form-control','placeholder'=>'Razón
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 col-xs-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('pais',[ 'AF' => 'Afganistán','AL' => 'Albania','DE' => 'Alemania','AD' =>
                        'Andorra',
                        'AO' => 'Angola','AI' => 'Anguilla','AQ' => 'Antártida','AG' => 'Antigua y Barbuda','AN' =>
                        'Antillas Holandesas',
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 col-xs-6">
                    <div class="form-group">
                        ...
                        {!! Form::email('email', 'notiene@hotmail.com', ['class' => 'form-control'
                        ,'placeholder'=>'Email...']) !!}
                    </div>
                </div>
