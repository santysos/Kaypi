...
<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1"
    id="modalagregarempaquetado-{{$dt->idtb_detalle_orden}}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <label for="usr">Realizado: {{$dt->suma_emp}}<br>
                        Faltante: {{$dt->cantidad-$dt->suma_emp}}<br>
                        {{$dt->nombre}}
                    </label>
                    ...
                    {!!Form::hidden('tb_departamentos_idtb_departamentos',7,['class'=>'form-control'])!!}
                </div>
