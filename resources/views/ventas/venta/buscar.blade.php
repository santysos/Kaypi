          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="info-box bg-green">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">${{$ventas->suma_abonos-$ventas->abonos}} de
                  ${{$ventas->total_ventas_impagas}}</span>
                <div class="progress">
                  @if($ventas->total_ventas_impagas>0)
                  <div class="progress-bar"
                    style="width: {{(($ventas->suma_abonos-$ventas->abonos)*100)/$ventas->total_ventas_impagas}}%"></div>
                  @else
                  <div>0</div>
                  @endif
                </div>
            ...
            <table class="table table-striped table-borderless table-condensed table-hover">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a class="subraya" title="Agregar Pago" href="" data-target="#modal-create-pago-{{$cat->idtb_venta}}"
                    data-toggle="modal">
                ...
                <td>
                  <a title="Detalle Venta" href="{{URL::action('VentaController@show',$cat->idtb_venta)}}"><button
                      type="button" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-list-alt"
                ...
                <td>
                  ...
                  <span class="pull-right-container">
                    <small class="label pull-center bg-green"><a target="_blank" style="color:#fff" ;
                        href="http://162.243.161.165:9090/rest/v1/pdf/codigo/FV/numero/{{$cat->numero}}">{{$estado->estado}}</a></small>
                  </span>
